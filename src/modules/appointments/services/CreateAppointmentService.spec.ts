...
let createApppointment: CreateAppointmentService;
...
describe('CreateApppointment', () => {
  beforeEach(() => {
    ...
    createApppointment = new CreateAppointmentService(
  ...
  it('should not be able to create an appointment outside the avaiable schedule', async () => {
    jest.spyOn(Date, 'now').mockImplementationOnce(() => {
      return new Date(2020, 4, 10, 12).getTime();
    });
    await expect(
